...
public:
	...
	virtual Path run(const BasicGraph& G, const State& start, const vector<pair<int, int> >& goal_location, ReservationTable& RT, const unordered_map<int, int>& approximate_goals) {return Path(); };
