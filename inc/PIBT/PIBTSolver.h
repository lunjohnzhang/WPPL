...
public:
    ...
    bool prior_to(const int i, const int j) const {
        ...
        if (prior_type==SHORT_DIST){
            ...
            double d1=heuristics.get(a.curr_state.location,a.curr_state.orientation,a.goal_location);
            double d2=heuristics.get(b.curr_state.location,b.curr_state.orientation,b.goal_location);
