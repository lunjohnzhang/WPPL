...
./build/lifelong --inputFile example_problems/random.domain/random_100.json $ARGS -o offline_eval/1121/test_random_100.json --simulationTime 500 
./build/lifelong --inputFile example_problems/random.domain/random_200.json $ARGS -o offline_eval/1121/test_random_200.json --simulationTime 500 
./build/lifelong --inputFile example_problems/random.domain/random_400.json $ARGS -o offline_eval/1121/test_random_400.json --simulationTime 1000 
./build/lifelong --inputFile example_problems/random.domain/random_600.json $ARGS -o offline_eval/1121/test_random_600.json --simulationTime 1000 
./build/lifelong --inputFile example_problems/random.domain/random_800.json $ARGS -o offline_eval/1121/test_random_800.json --simulationTime 2000 
...
./build/lifelong --inputFile example_problems/warehouse.domain/warehouse_large_8000.json $ARGS -o offline_eval/1121/test_warehouse.json --simulationTime 5000 
...
./build/lifelong --inputFile example_problems/warehouse.domain/sortation_large_10000.json $ARGS -o offline_eval/1121/test_sortation.json --simulationTime 5000 
...
./build/lifelong --inputFile example_problems/game.domain/brc202d_4000.json $ARGS  -o offline_eval/1121/test_brc202d.json --simulationTime 5000 
...
./build/lifelong --inputFile example_problems/city.domain/paris_1000.json $ARGS -o offline_eval/1121/test_paris_1000.json --simulationTime 2000 
# ./build/lifelong --inputFile example_problems/city.domain/paris_2000.json $ARGS
./build/lifelong --inputFile example_problems/city.domain/paris_3000.json $ARGS -o offline_eval/1121/test_paris_3000.json --simulationTime 4000 
