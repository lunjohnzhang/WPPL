...
# ./build/lifelong --inputFile example_problems/ranodm.domain/random_600.json $ARGS
# ./build/lifelong --inputFile example_problems/ranodm.domain/random_800.json $ARGS
