...
void LNSSolver::initialize(const SharedEnvironment & env){
    ...
    // TODO: make it attribute of the class.
    ...
    planning_window=window_size_for_CT; // TODO: read from config & initialized in constructor
    execution_window=read_param_json<int>(config,"execution_window"); // TODO: read from config & initialized in constructor
...
void LNSSolver::plan(const SharedEnvironment & env){
    ...
    // TODO: we need to replan for all agents that has no plan
    ...
    if (planning_paths[0].size()<planning_window+1) {
        ...
        // TODO: maybe we should directly build lacam2 planner in this class.
        if (read_param_json<string>(config,"initAlgo")=="LaCAM2"){
            ...
            // TODO: the following line may need to be optimized. There is no need to rebuild the graph G again.
            lacam2_solver->clear(env);
            
            // TODO: we should avoid copy here. we may use deque for paths.
    ...
    // TODO: not sure what's bug making it cannot be placed in initialize()    
    ...
    for (int i=0;i<lns->agents.size();i++){
        ...
        // TODO: it is not correct on weighted maps
