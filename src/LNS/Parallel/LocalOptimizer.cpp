...
LocalOptimizer::LocalOptimizer(
    ...
    // TODO: for agent_id, we just use 0 to initialize the path planner. but we need to change it (also starts and goals) everytime before planning
...
bool LocalOptimizer::runPP(Neighbor & neighbor, const TimeLimiter & time_limiter)
{
    ...
    // TODO: we require the path to be at least window_size_for_PATH
    // TODO: we use hold goal location assumption here, which is not necessary.
    ...
    while (p != shuffled_agents.end()) {
        ...
        // TODO: this might not be a smart choice, but it keeps everything consistent.
